' -----------------------------------------------------------------------------
' <copyright file="ReportForm_ProfPVICurve.vb" company="Autodesk">
...
Friend Class ReportForm_ProfPVICurve
    '
    'Main entry point for this reports application
    '
    Public Shared Sub Run()
        If CanOpen() Then
            ReportUtilities.RunModalDialog(New ReportForm_ProfPVICurve)
        End If
    End Sub
    ...
    Private Sub ReportForm_ProfPVICurve_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub WriteHtmlReport(ByVal fileName As String)
        ...
        oReportHtml.RenderHeader(LocalizedRes.ProfPVICurve_Html_Title)

        '<body>
        oReportHtml.BodyBegin()
        '<h1>
        oReportHtml.RenderH(LocalizedRes.ProfPVICurve_Html_Header, 1)
    ...
    Private Sub AppendReport(ByVal oProfile As AeccLandLib.AeccProfile, _
        ...
        'extract data
        ProfPVICurve_ExtractData.ExtractData(oProfile, stationStart, stationEnd)
        ...
        If oProfile.Type = AeccLandLib.AeccProfileType.aeccExistingGround Then
            'title
            oHtmlWriter.TrBegin()
            oHtmlWriter.RenderTd(LocalizedRes.ProfPVICurve_Html_TblTitle_PVI, True)
            oHtmlWriter.RenderTd(LocalizedRes.ProfPVICurve_Html_TblTitle_Station, True)
            oHtmlWriter.RenderTd(LocalizedRes.ProfPVICurve_Html_TblTitle_GradeOut, True)
            oHtmlWriter.TrEnd()

            For i As Integer = 0 To UBound(ProfPVICurve_ExtractData.ProfileDataArr)
                If ProfPVICurve_ExtractData.ProfileDataArr(i) Is Nothing Then
                    Exit For
                End If

                'format string
                oHtmlWriter.TrBegin()
                oHtmlWriter.RenderTd(i.ToString("N"))
                oHtmlWriter.RenderTd(ProfPVICurve_ExtractData.ProfileDataArr(i)(ProfPVICurve_ExtractData.nStationIndex))
                oHtmlWriter.RenderTd(ProfPVICurve_ExtractData.ProfileDataArr(i)(ProfPVICurve_ExtractData.nGradeOutIndex))
                oHtmlWriter.TrEnd()
            Next i
        ElseIf oProfile.Type = AeccLandLib.AeccProfileType.aeccFinishedGround Then
            ...
            oHtmlWriter.RenderTd(LocalizedRes.ProfPVICurve_Html_TblTitle_Station, True)
            oHtmlWriter.RenderTd(LocalizedRes.ProfPVICurve_Html_TblTitle_GradeOut, True)
            oHtmlWriter.RenderTd(LocalizedRes.ProfPVICurve_Html_TblTitle_CurveLength, True)
            oHtmlWriter.TrEnd()
            ...
            For i As Integer = 0 To UBound(ProfPVICurve_ExtractData.ProfileDataArr)
                ...
                If ProfPVICurve_ExtractData.ProfileDataArr(i)(ProfPVICurve_ExtractData.nCurveInfo) Is Nothing Then
                    bCurve = False
                Else
                    bCurve = True
                End If
                ...
                If bCurve Then
                    sCurveLen = CStr(ProfPVICurve_ExtractData.ProfileDataArr(i)(ProfPVICurve_ExtractData.nCurveInfo)(ProfPVICurve_ExtractData.nCurveLenIndex))
                Else
                    sCurveLen = "&nbsp;"
                End If
                ...
                oHtmlWriter.RenderTd(ProfPVICurve_ExtractData.ProfileDataArr(i)(ProfPVICurve_ExtractData.nStationIndex))
                oHtmlWriter.RenderTd(ProfPVICurve_ExtractData.ProfileDataArr(i)(ProfPVICurve_ExtractData.nGradeOutIndex))
                oHtmlWriter.RenderTd(sCurveLen)
                oHtmlWriter.TrEnd()
    ...
    Private Sub writeCurveInfoHeader(ByVal nNumber As Integer, ByVal oHtmlWriter As ReportWriter)
        ...
        oCurveDataArr = ProfPVICurve_ExtractData.ProfileDataArr(nNumber)(ProfPVICurve_ExtractData.nCurveInfo)

        If oCurveDataArr(ProfPVICurve_ExtractData.nCurvTypeIndex) = AeccLandLib.AeccProfileVerticalCurveType.aeccSag Then
    ...
    Private Sub WriteCurveInfo(ByVal nNumber As Integer, ByVal oHtmlWriter As ReportWriter)
        ...
        WriteTypeValueRecord2(LocalizedRes.ProfPVICurve_Html_PVCStation, _
                            oCurveDataArr(ProfPVICurve_ExtractData.nPVCStationIndex), _
                            LocalizedRes.ProfPVICurve_Html_Elevation, _
                            oCurveDataArr(ProfPVICurve_ExtractData.nPVCElevationIndex), _
                            oHtmlWriter, True)   '"PVC Station:","Elevation:"
        WriteTypeValueRecord2(LocalizedRes.ProfPVICurve_Html_PVIStation, _
                            ProfPVICurve_ExtractData.ProfileDataArr(nNumber)(ProfPVICurve_ExtractData.nStationIndex), _
                            LocalizedRes.ProfPVICurve_Html_Elevation, _
                            ProfPVICurve_ExtractData.ProfileDataArr(nNumber)(ProfPVICurve_ExtractData.nElevationIndex), _
                            oHtmlWriter) '"PVI Station:" "Elevation:"
        WriteTypeValueRecord2(LocalizedRes.ProfPVICurve_Html_PVTStation, _
                            oCurveDataArr(ProfPVICurve_ExtractData.nPVTStationIndex), _
                            LocalizedRes.ProfPVICurve_Html_Elevation, _
                            oCurveDataArr(ProfPVICurve_ExtractData.nPVTElevationIndex), _
                            oHtmlWriter) '"PVT Station:" "Elevation:"

        If TypeName(oCurveDataArr(ProfPVICurve_ExtractData.nHighStationIndex)) = "String" Then
            WriteTypeValueRecord2(LocalizedRes.ProfPVICurve_Html_HighPoint, _
                                oCurveDataArr(ProfPVICurve_ExtractData.nHighStationIndex), _
                                LocalizedRes.ProfPVICurve_Html_Elevation, _
                                oCurveDataArr(ProfPVICurve_ExtractData.nHightElevation), _
                                oHtmlWriter) '"High Point:"  "Elevation:"
        End If

        If TypeName(oCurveDataArr(ProfPVICurve_ExtractData.nLowStationIndex)) = "String" Then
            WriteTypeValueRecord2(LocalizedRes.ProfPVICurve_Html_LowPoint, _
                                oCurveDataArr(ProfPVICurve_ExtractData.nLowStationIndex), _
                                LocalizedRes.ProfPVICurve_Html_Elevation, _
                                oCurveDataArr(ProfPVICurve_ExtractData.nLowElevation), _
                                oHtmlWriter) '"Low Point:" "Elevation:"
        End If

        WriteTypeValueRecord2(LocalizedRes.ProfPVICurve_Html_GradeIn, _
                            oCurveDataArr(ProfPVICurve_ExtractData.nGradeInIndex), _
                            LocalizedRes.ProfPVICurve_Html_GradeOut, _
                            ProfPVICurve_ExtractData.ProfileDataArr(nNumber)(ProfPVICurve_ExtractData.nGradeOutIndex), _
                            oHtmlWriter, True) '"Grade in(%):" "Grade out(%):"
        WriteTypeValueRecord2(LocalizedRes.ProfPVICurve_Html_Change, _
                            oCurveDataArr(ProfPVICurve_ExtractData.nGradeChange), _
                            LocalizedRes.ProfPVICurve_Html_K, _
                            oCurveDataArr(ProfPVICurve_ExtractData.nKIndex), _
                            oHtmlWriter) '"Change(%):" "K:"

        WriteTypeValueRecord2(LocalizedRes.ProfPVICurve_Html_CurveLength, _
                            oCurveDataArr(ProfPVICurve_ExtractData.nCurveLenIndex), _
                            "", _
                            "", _
                            oHtmlWriter, True) '"Curve Length:"
        If oCurveDataArr(ProfPVICurve_ExtractData.nCurvTypeIndex) = AeccLandLib.AeccProfileVerticalCurveType.aeccSag Then
            WriteTypeValueRecord2(LocalizedRes.ProfPVICurve_Html_HeadlightDistance, _
                                oCurveDataArr(ProfPVICurve_ExtractData.nHeadlightDisIndex), _
                                "", _
                                "", _
                                oHtmlWriter) '"Headlight Distance:"
        Else
            WriteTypeValueRecord2(LocalizedRes.ProfPVICurve_Html_PassingDistance, _
                                oCurveDataArr(ProfPVICurve_ExtractData.nPassingDisIndex), _
                                LocalizedRes.ProfPVICurve_Html_StoppingDistance, _
                                oCurveDataArr(ProfPVICurve_ExtractData.nStoppingDisIndex), _
    ...
    Private Sub openHelp()
        ReportApplication.InvokeHelp(ReportHelpID.IDH_AECC_REPORTS_CREATE_PVI_STATION_AND_CURVE_REPORT)
    End Sub
